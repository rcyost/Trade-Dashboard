...
partnerEconomies=get_partner_economies(key=key)
...
indicators.to_csv(str(products['datasets']))
reportEcon.to_csv(str(products['reportEcon']))
partnerEconomies.to_csv(str(products['partnerEconomies']))
products.to_csv(str(products['products']))
